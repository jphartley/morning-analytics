...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Save error toast */}
      {saveError && (
        <div className="fixed bottom-4 right-4 bg-error-soft border border-error-outline text-error-strong px-4 py-3 rounded-lg shadow-lg flex items-center gap-3">
