...
**Resolved:** Error state colors are tokenized through semantic theme variables in `app/app/globals.css`, including the error state view, auth form errors, history load errors, and the save-error toast.
