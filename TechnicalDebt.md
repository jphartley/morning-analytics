...
**Resolved:** Error state colors tokenized — shared `--error*` theme tokens now back the error state, auth error banners, history load error text, and save-error toast.
