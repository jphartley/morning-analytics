...
**Resolved:** Error state colors now use shared semantic error tokens instead of hardcoded red Tailwind classes, including Midnight-specific overrides for contrast.
