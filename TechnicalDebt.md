...
**Resolved:** Error state colors now use shared semantic error tokens instead of hardcoded red utility classes, so palette-aware theming stays centralized in `app/app/globals.css`.
