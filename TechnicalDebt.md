...
**Resolved:** Error state colors are tokenized with shared semantic error tokens in `app/app/globals.css`; hardcoded error color utilities were removed from error surfaces.
