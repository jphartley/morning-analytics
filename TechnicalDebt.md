...
**Resolved:** Error state colors now use semantic error tokens in `app/app/globals.css`; `ErrorState.tsx` and the save-error toast no longer rely on hardcoded red utility classes.
