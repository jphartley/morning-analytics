...
**Resolved:** Error state colors are tokenized via semantic error palette variables in `app/app/globals.css`, replacing the remaining hardcoded error utility classes in current UI error surfaces.
