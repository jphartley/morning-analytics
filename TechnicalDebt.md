...
**Resolved:** Error state colors now use semantic error tokens (`--error`, `--error-soft`, `--error-border`, `--error-contrast`) across shared UI surfaces instead of hardcoded red utilities; removed from open debt.
