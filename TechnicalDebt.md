...
**Resolved:** Error surfaces now use semantic error tokens instead of hardcoded red utility classes, including the main error state, save-error toast, auth form errors, and history load errors.
