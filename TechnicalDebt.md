...
**Resolved:** Error state colors now use shared semantic tokens (`--error`, `--error-foreground`, `--error-soft`, `--error-border`) instead of hardcoded red utility classes in app error surfaces.
