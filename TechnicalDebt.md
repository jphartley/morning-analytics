...
**Resolved:** Error state colors now use semantic error tokens across shared UI surfaces, including `ErrorState.tsx` and the save-error toast; removed from open debt.
