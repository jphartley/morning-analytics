...
**Resolved:** Error state colors now use shared semantic tokens instead of hardcoded Tailwind red classes across the primary error surfaces, including `ErrorState.tsx`, auth form errors, history load errors, and the save-error toast.
