...
**Resolved:** Error state colors now use shared semantic tokens (`error`, `error-soft`, `error-outline`, `error-strong`) across the shared error view, auth error banners, history sidebar, and save-error toast.
