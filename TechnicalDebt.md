...
**Resolved:** Error state colors now use shared semantic error tokens (`--error`, `--error-soft`, `--error-border`, and stronger variants) across app error surfaces; removed from open debt.
