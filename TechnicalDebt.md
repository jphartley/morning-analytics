...
**Resolved:** Error state colors are now tokenized through shared semantic error tokens in `app/app/globals.css`, and the main app plus auth error surfaces use those tokens instead of hardcoded red utility classes.
