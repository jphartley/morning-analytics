...
**Resolved:** Error state colors now use semantic palette tokens (`--error`, `--error-soft`, `--error-border`, `--error-contrast`) instead of hardcoded red utility classes across shared error surfaces.
