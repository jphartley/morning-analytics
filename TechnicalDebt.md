...
- **Resolved:** Shared semantic error tokens now style the full-page `ErrorState`, auth form error banners, history load errors, and the save-error toast instead of hardcoded `bg-red-*`, `text-red-*`, and `border-red-*` utilities.
