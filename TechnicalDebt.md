...
**Resolved:** Error state colors are now tokenized with shared semantic error tokens in `app/app/globals.css`; error UI no longer depends on hardcoded red Tailwind classes.
