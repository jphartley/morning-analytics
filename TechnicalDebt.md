...
**Resolved:** Error surfaces now use semantic error tokens (`--error`, `--error-strong`, `--error-soft`, `--error-subtle`, `--error-border`) instead of hardcoded red utility classes; removed from open debt.
