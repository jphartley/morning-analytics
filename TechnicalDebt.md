...
**Resolved:** Error states now use shared semantic error tokens in the palette theme instead of hardcoded red utility classes, including a Midnight override for dark-mode readability.
