...
**Resolved:** Error state colors now use shared semantic error tokens in `app/app/globals.css`, replacing the remaining hardcoded red utility classes in shared error surfaces.
