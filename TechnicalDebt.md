...
**Resolved:** Error state colors now use shared semantic error tokens across the main app and auth surfaces, so they can be maintained from the palette token layer.
