...
- **Resolved:** Error surfaces in `ErrorState.tsx` and the save-error toast now use shared semantic error tokens in `globals.css` instead of hardcoded red utilities.
