...
**Resolved:**
- Flash of default palette on page load — stored palette is applied before first paint; removed from open debt.
- Error state colors tokenized — shared semantic error tokens now drive `ErrorState.tsx`, auth error banners, `HistorySidebar.tsx`, and the save-error toast.
