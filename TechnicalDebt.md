...
- **Resolved:** Error state colors in `ErrorState.tsx` and the save-error toast now use semantic `--error*` palette tokens instead of hardcoded Tailwind red utilities.
