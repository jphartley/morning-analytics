...
**Resolved:** Error states now use shared semantic error tokens (`--error`, `--error-soft`, `--error-outline`) from `app/app/globals.css`, replacing hardcoded red utilities in error banners and toasts.
