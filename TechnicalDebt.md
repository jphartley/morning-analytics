...
**Resolved:** Error state colors now use semantic error tokens (`--error`, `--error-contrast`, `--error-soft`, `--error-border`) instead of hardcoded red utility classes in shared error surfaces.
