...
- [x] 5.4 Before production testing, promote the owner-supplied accounts through Supabase, review Railway production variable changes, and deploy/redeploy; verify an administrator and a normal user each see the intended experience.
