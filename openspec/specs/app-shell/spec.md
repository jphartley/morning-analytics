...
- **THEN** the app SHALL show a small, low-emphasis diagnostics disclosure near the image loading area
- **THEN** the diagnostics disclosure SHALL indicate that the request is still running and detailed server events will appear after the request returns
...
- **THEN** the collapsed disclosure SHALL be visually minimal and secondary to the generated images
