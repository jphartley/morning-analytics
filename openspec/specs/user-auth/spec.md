...
Define email/password authentication behavior and visual consistency for auth pages.
...
#### Scenario: Visual consistency with main app
- **WHEN** user views the signup page
- **THEN** page uses `bg-page` background, `bg-surface` card, `bg-accent` primary button, `text-ink` text color
- **THEN** page is visually consistent with the main app experience
- **THEN** the palette picker is visible and functional

### Requirement: Email/password signin
The system SHALL allow users to sign in using their registered email and password. The signin page SHALL use the same design token palette as the main app.
...
#### Scenario: Visual consistency with main app
- **WHEN** user views the signin page
- **THEN** page uses `bg-page` background, `bg-surface` card, `bg-accent` primary button, `text-ink` text color
- **THEN** page is visually consistent with the main app experience
- **THEN** the palette picker is visible and functional
