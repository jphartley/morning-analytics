...
- `prepare-test <change>`: run setup, verify, check planning checkout contamination and landing readiness, probe dev server readiness, and emit manual testing handoff.
